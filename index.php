    ...
    <div class="container">
      <div class="card">
        <div class="card-header">
          ...
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalUpdate" data-idproducto="1" data-nombre="test producto" data-precio="2.4" data-cantidad="2">Modificar</button>
            ...
            <form action="controller/productos.php" method="post">
                <div class="modal-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nombre" required="true" name="nombre" placeholder="Ingrese Nombre Producto">
                    </div>
                    <div class="form-group">
                      <label for="cantidad">Cantidad Productos</label>
                      <input type="number" min="0" step="1" class="form-control" id="cantidad" name="cantidad" required="true" placeholder="Ingrese Cantidad de Producto">
                    </div>
                    <div class="form-group">
                      <label for="precio">Precio Producto</label>
                      <input type="number" min="0" step="0.1" class="form-control" id="precio" name="precio" required="true" placeholder="Ingrese Precio Unitario del Producto">
                    </div>
